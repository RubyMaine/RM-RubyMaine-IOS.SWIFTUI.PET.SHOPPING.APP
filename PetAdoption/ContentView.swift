        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 20) {
                PagingView(index: $currentIndex, maxIndex: _maxIndex) {
                    SplashView(image: "splash.image.1", title: "Завести новых друзей", description: "Здесь вы можете встретить друга своей мечты и порадоваться вместе с ними приходте.")
                    SplashView(image: "splash.image.2", title: "Не делайте покупки! Усыновить", description: "Большинство усыновляемых домашних животных происходят из любящих домов, которые просто не могут больше о них заботиться.")
                    SplashView(image: "splash.image.3", title: "Прими нового друга", description: "Есть поговорка. Если вы хотите, чтобы кто-то любил вас вечно, приютите нового друга, накормите его и держите рядом.")
                }
