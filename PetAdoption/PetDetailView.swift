    ...
    var body: some View {
        VStack {
            ScrollView (.vertical) {
                ...
                HStack(spacing: 20) {
                    BoxDetailView(title: "Возраст", description: "\(pet.age) месяцев")
                    BoxDetailView(title: "Вес", description: "\(pet.weight) кг")
                    BoxDetailView(title: "Пол", description: pet.gender.rawValue.capitalized)
                }
                .padding(.top, 10)
